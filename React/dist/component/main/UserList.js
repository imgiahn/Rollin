    ...
    return (<>
      ...
      <div className="container ">
        ...
        <div className="row row-cols-4">
          {users === null || users === void 0 ? void 0 : users.map((user, index) => (<figure key={index} className="figure">
              <figcaption className="figure-caption text-center">{user.id}</figcaption>
              <img className="img-thumbnail col" key={user.id} src={user.img} alt={user.name} id={user.id} title={user.userId} onClick={(e) => {
