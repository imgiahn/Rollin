...
export const { selectAllGifts, load, load2, load3, selectGiftByKey, selectReceivers, insertGift, insertGiftFail, requestSort, requestGetGiftName } = giftsSlice.actions;
