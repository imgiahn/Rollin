...
const Gifts = () => {
    ...
    return (React.createElement("div", { className: "container" },
        ...
        React.createElement("div", { className: "row row-cols-4" }, allGifts === null || allGifts === void 0 ? void 0 : allGifts.map((gift, index) => (React.createElement("figure", { key: index, className: "figure" },
            React.createElement("img", { className: "img-thumbnail col", key: gift.id, src: `${IMG_PATH}${gift.img}`, alt: gift.name, id: gift.id, content: gift.content, count: gift.count, name: gift.name, view: gift.views, onClick: (e) => onClickImg(e) }),
