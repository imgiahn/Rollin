...
const GiftDetail = () => {
    ...
    const onChangeSelect = (e) => {
        ...
        setForm(Object.assign(Object.assign({}, form), { receiverId: Number(value) }));
    };
    ...
    return (<div className="GiftDetailPage">
      ...
      <Form>
        ...
        <Input type="select" name="receiver" id="receiverSelect" onChange={(e) => onChangeSelect(e)}>
          {(_a = receiversInfo.receivers) === null || _a === void 0 ? void 0 : _a.map((receiver, index) => (<option value={receiver.id}>{receiver.name}</option>))}
        </Input>
        <br />
        메시지 :
